        ...
        <main className='flex flex-col xl:flex-row'>
            ...
            <div className='mx-5 my-10 space-y-5 text-sm lg:m-16 lg:my-20 xl:border-l xl:pl-14'>
                <div>
                    ...
                    <p className='mt-3 text-justify'>{resume.basics.summary}</p>

                    {resume.works[0]?.location && (
                        <Link className='mt-2 flex items-center text-[#888] hover:text-hover' href={resume.works[0].location.url}>
                ...
                {sections.map((section, index) => {
                    return (
                        <div className='text-sm' key={index}>
                            ...
                            <div className='mt-2 flex flex-wrap gap-y-2 gap-x-5 text-[#888]'>
                                {section.location && (
